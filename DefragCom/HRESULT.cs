...
public partial struct HRESULT
{
    ...
    /// <summary></summary>
    public const int WBEM_E_ACCESS_DENIED = unchecked((int)0x80041003);
    ...
    /// <summary/>
    public static readonly HRESULT HR_OR_INVALID_OXID = Make(true, FacilityCode.FACILITY_WIN32, 0x776);
    ...
    public const int HRESULT_ERROR_IO_PENDING = unchecked((int)0x800703E5);
}

public partial struct HRESULT : IComparable, IComparable<HRESULT>, IEquatable<HRESULT>, IEquatable<int>, IEquatable<uint>, IConvertible
{
    ...
    /// <summary>Converts this error to an <see cref="T:Workplace.Container.Common.Win32.HRESULT"/>.</summary>
    /// <returns>An equivalent <see cref="T:Workplace.Container.Common.Win32.HRESULT"/>.</returns>
    // ReSharper disable once UnusedMember.Local
    HRESULT ToHRESULT() => this;
